			...
			<Box sx={{ flexGrow: 1, bgcolor: 'background.default', p: 3 }}>
				<div>
					...
					<Accordion defaultExpanded>
						...
						id="panel1a-header"
						>
						<Typography sx={{ pl: 2 }}>Fall 2021 🍂</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Spring 2022 🍃</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Fall 2022 🍂</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Spring 2023 🍃</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Fall 2023 🍂</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Spring 2024 🍃</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Fall 2024 🍂</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion defaultExpanded>
						...
						id="panel2a-header"
						>
						<Typography sx={{ pl: 2 }}>Spring 2025 🍃</Typography>
						</AccordionSummary>
						<AccordionDetails>
